...
This document is the consolidated framework reference for TanStack Start on Netlify. It covers routing, data loading, server functions, API routes, authentication, content collections, and forms. All AI agents (Claude, Gemini, Codex) should use this as the authoritative guide for TanStack Start patterns in this project.
